...
export const requestLocatePermission = async () => {
    try {
        const granted = await PermissionsAndroid.request(
            ...
            {
                title: 'Inside Maps location permission',
                message:
                    'Inside Maps app needs location data to allow for placing points in multiple locations',
        ...
        if (granted === PermissionsAndroid.RESULTS.GRANTED) {
            console.log('You can now place points');
        } else {
